...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Person_name = new Property(2, String.class, "person_name", false, "PERSON_NAME");
        public final static Property Person_last_name = new Property(3, String.class, "person_last_name", false, "PERSON_LAST_NAME");
        public final static Property Id_profession = new Property(4, long.class, "id_profession", false, "ID_PROFESSION");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PERSON\" (" + //
                ...
                "\"ID_PERSON\" INTEGER NOT NULL ," + // 1: id_person
                "\"PERSON_NAME\" TEXT," + // 2: person_name
                "\"PERSON_LAST_NAME\" TEXT," + // 3: person_last_name
                "\"ID_PROFESSION\" INTEGER NOT NULL );"); // 4: id_profession
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Person entity) {
        ...
        stmt.bindLong(2, entity.getId_person());
 
        String person_name = entity.getPerson_name();
        if (person_name != null) {
            stmt.bindString(3, person_name);
        }
 
        String person_last_name = entity.getPerson_last_name();
        if (person_last_name != null) {
            stmt.bindString(4, person_last_name);
        }
        stmt.bindLong(5, entity.getId_profession());
    }
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.getLong(offset + 1), // id_person
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // person_name
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // person_last_name
            cursor.getLong(offset + 4) // id_profession
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setId_person(cursor.getLong(offset + 1));
        entity.setPerson_name(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
        entity.setPerson_last_name(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setId_profession(cursor.getLong(offset + 4));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN PROFESSION T0 ON T.\"ID_PROFESSION\"=T0.\"_id\"");
            builder.append(' ');
